...
public final class Constants {
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -45 / 360.0; // Input between -180 and 180 degrees.
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -43  / 360.0; // Input between -180 and 180 degrees.
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -70 / 360.0; // Input between -180 and 180 degrees.

    public static final int BACK_RIGHT_MODULE_DRIVE_MOTOR = 8;
    public static final int BACK_RIGHT_MODULE_STEER_MOTOR = 4;
    public static final int BACK_RIGHT_MODULE_STEER_ENCODER = 52;
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = 11 / 360.0; // Input between -180 and 180 degrees.
